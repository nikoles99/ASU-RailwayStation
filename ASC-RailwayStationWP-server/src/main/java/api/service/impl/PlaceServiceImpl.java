...
public class PlaceServiceImpl implements PlaceService {
  ...
  @Override
  public Map<CarriageType, Integer> getFreePlaces(Integer trainId, Date departureDate, Date arrivalDate) {
    Map<CarriageType, Integer> freePlaceMap = new HashMap<CarriageType, Integer>();
    putSize(trainId, departureDate, arrivalDate, CarriageType.COMMON, freePlaceMap);
    putSize(trainId, departureDate, arrivalDate, CarriageType.SEAT_PLACE, freePlaceMap);
    putSize(trainId, departureDate, arrivalDate, CarriageType.RESERVED_SEAT, freePlaceMap);
    putSize(trainId, departureDate, arrivalDate, CarriageType.COUP, freePlaceMap);
    return freePlaceMap;
  }

  private void putSize(Integer trainId, Date departureDate, Date arrivalDate,
                       CarriageType type, Map<CarriageType, Integer> freePlaceMap) {
    List<PlaceBean> freePlaces = getFreePlaces(trainId, type, departureDate, arrivalDate);
    freePlaceMap.put(type, freePlaces.size());
  }
}
